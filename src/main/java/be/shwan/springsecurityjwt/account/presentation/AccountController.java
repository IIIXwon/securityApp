...
//    private final JwtTokenUtil jwtTokenUtil;
    ...
    @PostMapping("/login")
    public ResponseEntity<String> login(@RequestBody SignUpForm loginForm) throws JsonProcessingException, NoSuchAlgorithmException, InvalidKeyException {
        ...
        if (account == null) {
            ...
            return ResponseEntity.ok().body("로그인 되었습니다. jwt : " + jwt);
        }
    }
}